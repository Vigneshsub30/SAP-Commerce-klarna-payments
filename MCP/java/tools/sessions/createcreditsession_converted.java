/**
 * MCP Server function for Create a new payment session
 */
...
class Post_Payments_V1_SessionsMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getPost_Payments_V1_SessionsHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("order_lines")) {
            queryParams.add("order_lines=" + args.get("order_lines"));
                ...
                String url = config.getBaseUrl() + "/api/v2/post_payments_v1_sessions" + queryString;
    ...
    public static MCPServer.Tool createPost_Payments_V1_SessionsTool(MCPServer.APIConfig config) {
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "post_payments_v1_sessions",
            "Create a new payment session",
            parameters
        );
        
        return new MCPServer.Tool(definition, getPost_Payments_V1_SessionsHandler(config));
    }
