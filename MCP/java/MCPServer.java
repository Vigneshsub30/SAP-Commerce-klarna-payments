...
// Import Post_Payments_V1_Sessions_Session_IdMCPTool - included in same package
// Import Post_Payments_V1_SessionsMCPTool - included in same package
// Import Get_Payments_V1_Sessions_Session_IdMCPTool - included in same package
// Import Delete_Payments_V1_Authorizations_Authorization_TokenMCPTool - included in same package
// Import Post_Payments_V1_Authorizations_Authorization_Token_OrderMCPTool - included in same package
// Import Post_Payments_V1_Authorizations_Authorization_Token_Customer_TokenMCPTool - included in same package
...
public class MCPServer {
    ...
    public static void main(String[] args) {
        try {
            ...
            // Register all tools
            tools = Arrays.asList(
            Post_Payments_V1_Sessions_Session_IdMCPTool.createPost_Payments_V1_Sessions_Session_IdTool(config),
            Post_Payments_V1_SessionsMCPTool.createPost_Payments_V1_SessionsTool(config),
            Get_Payments_V1_Sessions_Session_IdMCPTool.createGet_Payments_V1_Sessions_Session_IdTool(config),
            Delete_Payments_V1_Authorizations_Authorization_TokenMCPTool.createDelete_Payments_V1_Authorizations_Authorization_TokenTool(config),
            Post_Payments_V1_Authorizations_Authorization_Token_OrderMCPTool.createPost_Payments_V1_Authorizations_Authorization_Token_OrderTool(config),
            Post_Payments_V1_Authorizations_Authorization_Token_Customer_TokenMCPTool.createPost_Payments_V1_Authorizations_Authorization_Token_Customer_TokenTool(config)
            );
